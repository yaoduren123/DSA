(function() {
    ...
    function c(e, t) {
        var n = f(e), r = a._getSID(e);
        if (n["js-download"] || n.btn_download || n.btn_resume || n.btn_update)
            return setTimeout(function() {
                var n = !0;
                typeof window.__continueDownload__ == "function" && (n = __continueDownload__(r, e, t)), n && a.download(r, e)
            }, 50), !0;
        if (n.btn_downloading)
            return !0;
        if (n["js-detail"] || n["app-item"]) {
            var i = !1;
            window.__stopGotoDetail__ && (i = __stopGotoDetail__(r));
            if (!i) {
    ...
    var e = {}, t = {}, n = {}, r = e.util = {param: function(e) {
            var t = [];
            for (var n in e)
                t.push(n + "=" + encodeURIComponent(e[n]));
            return t.join("&")
        },getQuery: function(e) {
            var t = window.location.search.substr(1), n = t.split("&");
            ...
            return typeof e == "string" ? JSON.parse(e) : {version: "0",imei: "",os: "7"}
        },log: function(e) {
            ...
            if (t.push)
                for (var n = 0, r = t.length; n < r; n++)
                    window[e][t[n].soft_id] = t[n];
            else
                this.mix(window[e], t, !0)
        ...
        try {
    ...
    }(), s = "____guid", o = {get: function() {
            return window.gmid || this.guid || i && window.localStorage[s] || r.cookie(s) || this.getMobileMID()
        },_save: function(e) {
            i ? window.localStorage[s] = e : r.cookie(s, e, {expires: 777}), this.guid = e
        },getMobileMID: function() {
            var e = r.getQuery("m2");
            if (e && e.length == 32)
                return this._save(e), e;
            try {
            ...
            function a() {
                var e = [n.appName, n.version, n.language || n.browserLanguage, n.platform, n.userAgent, r.width, "x", r.height, r.colorDepth, t.referrer].join(""), i = e.length, s = window.history.length;
                while (s)
                    e += s-- ^ i++;
                return (Math.round(Math.random() * 2147483647) ^ u(e)) * 2147483647
            }
            var e = s, t = document, n = navigator, r = window.screen, i = t.domain.toLowerCase(), o = n.userAgent.toLowerCase(), f;
    ...
    r.getMID = function() {
        ...
        if (this._clientInfo && !e)
            return this._clientInfo;
        var t = this.cmd("getClientInfo");
        return this._clientInfo = typeof t == "string" ? JSON.parse(t) : {version: 0,imei: this.getMID(),os: "7"}
    }, r.localStorageEnable = i, window.qStore = e, window.__gappDataHash = t;
    if (!window.addEventListener)
        return;
    var u = 1, a = {_getSID: function(e, t) {
            if (typeof e == "string")
                return e;
            var n;
            while (e && e != document) {
            ...
            var n = "__jsonp" + ++u, i = "http://openbox.mobilem.360.cn/index/getSoftInfoByIdsAccordingToFields/callback/" + n + "/sids/" + e + "/fields/", s = ["pname", "soft_id", "soft_name", "logo_url", "download_urls", "version_code", "apk_sizes", "signature_md5s", "type", "baike_name"];
            window[n] = t, r.scriptRequest(i + s.join("|"))
        },_getAppData: function(e, n, i, s) {
            if (!e)
                return (window.__showError__ || r.log)("ERROR: \u672a\u627e\u5230\u8f6f\u4ef6ID"), !1;
            var o = function(e) {
                return typeof window.__filterAppData__ == "function" && (e = __filterAppData__(e, i, s)), n(e)
            };
            if (typeof window.getAppData == "function" || typeof window.__getAppData__ == "function") {
                var u = (window.getAppData || __getAppData__)(e);
                if (u)
                    return o(u)
            }
            window.__gappDataHash[e] ? o(t[e]) : this._getRemoteAppData(e, function(n) {
                var i = n[e], n = r.mix({}, {apkid: i.pname,soft_id: i.soft_id,name: i.soft_name,baike_name: i.baike_name,type: i.type,logo_url: i.logo_url,version_code: i.version_code,down_url: i.download_urls.split(",")[0],signature_md5: i.signature_md5s.split(",")[0],size: i.apk_sizes.split(",")[0]});
                o(n), t[e] = n
            })
            ...
            this._getAppData(e, function(e) {
                var e = r.mix({page: "detail"}, e);
                r.cmd("gotoPage", JSON.stringify(e))
            }, "detail")
        },openPage: function(e) {
            r.cmd("openPage", e.getAttribute("href") || e.getAttribute("data-href"))
        },openApp: function(e) {
            this._getAppData(e, function(t) {
                var n = !1;
                window.__openNewResource__ && (n = window.__openNewResource__(e, t)), n || (t.type == "ebook" && t.cpbook_id && t.cpbook_detailurl && window.AndroidWebview && typeof AndroidWebview.openCPBook == "function" ? r.cmd("openCPBook", JSON.stringify(t)) : r.cmd("launchApp", JSON.stringify({apkid: t.apkid})))
            })
        },pause: function(e) {
            this._getAppData(e, function(e) {
    ...
    var e = qStore.util, t = [], n = !1, r = {getPageHref: function() {
            return location.protocol + "//" + location.host + location.pathname
        },getRefer: function() {
            return e.getQuery("refer")
        },getLogUrl: function(t, n, r, i) {
            var s = {u: this.getPageHref(),ver: "",mid: e.getQuery("m") || e.getMID(),cid: "",from: "",market_id: "360market",tj: "",refer: ""}, o = {sid: t || "",act: n || "",pos: r || "",_: (new Date).getTime()}, u = {};
    ...
    var e = {}, t = qStore.util.getClientInfo();
    e.pause = function() {
